...
describe('injectors', () => {
  ...
  describe('injectSaga helper', () => {
    ...
    it('should not start daemon and once-till-unmount sagas if they were started before', () => {
      store.runSaga = jest.fn()
    ...
    it('should restart a saga if different implemtnation for hot reloading', () => {
      const cancel = jest.fn()
    ...
    it('should not cancel saga if different implentation in production', () => {
      process.env.NODE_ENV = 'production'
      const cancel = jest.fn()
